	...
	return (
		<div className="bg-background">
			<section className="px-10 pt-[15vh] min-h-[90vh] pb-20">
				...
				allow any of your minor dependents to use this site. <br /> You
				...
				a destructive nature. <br /> A breach or violation of any of the
				Terms will result in an immediate termination of your Services.{" "}
				<br /> <br /> <strong>SECTION 2 - GENERAL CONDITIONS</strong>{" "}
				<br /> We reserve the right to refuse Service to anyone for any
				reason at any time. <br /> You understand that your content (not
				...
				of connecting networks or devices. Credit card information is
				always encrypted during transfer over networks. <br /> You agree
				...
				is provided, without express written permission by us. <br />{" "}
				...
				the material on this site is at your own risk. <br /> This site
				...
				notice at any time. <br /> We shall not be liable to you or to
				...
				any color will be accurate. <br /> We reserve the right, but are
				not obligated, to limit the sales of our products or Services to
				any person, geographic region or jurisdiction. We may exercise
				this right on a case-by-case basis. We reserve the right to
				...
				change at anytime without notice, at the sole discretion of us.
				...
				in the Service will be corrected. <br /> <br />{" "}
				<strong>
					SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION
				</strong>{" "}
				<br /> We reserve the right to refuse any order you place with
				...
				be placed by dealers, resellers or distributors. <br /> <br />{" "}
				...
				use of optional third-party tools. <br /> Any use by you of the
				...
				relevant third-party provider(s). <br /> We may also, in the
				...
				include materials from third-parties. <br /> Third-party links
				...
				products, or Services of third-parties. <br /> We are not liable
				...
				any comments; or (3) to respond to any comments. <br /> We may,
				but have no obligation to, monitor, edit or remove content that
				...
				(including after you have submitted your order). <br /> We
				...
				error-free. <br /> We do not warrant that the results that may
				be obtained from the use of the Service will be accurate or
				reliable. <br /> You agree that from time to time we may remove
				the Service for indefinite periods of time or cancel the Service
				at any time, without notice to you. <br /> You expressly agree
				that your use of, or inability to use, the Service is at your
				sole risk. The Service and all products and Services delivered
				...
				<strong>SECTION 14 - INDEMNIFICATION</strong> <br /> You agree
				to indemnify, defend and hold harmless {BRAND_NAME} and our
				...
				remaining provisions. <br /> <br />{" "}
				<strong>SECTION 16 - TERMINATION</strong> <br /> The obligations
				...
				purposes. <br /> These Terms of Service are effective unless and
				until terminated by either you or us. You may terminate these
				Terms of Service at any time by notifying us that you no longer
				...
				right or provision. <br /> These Terms of Service and any
				...
				the Terms of Service). <br /> Any ambiguities in the
				interpretation of these Terms of Service shall not be construed
				against the drafting party. <br /> <br />{" "}
				<strong>SECTION 18 - GOVERNING LAW</strong> <br /> These Terms
				of Service and any separate agreements whereby we provide you
				Services shall be governed by and construed in accordance with
				the laws of United States. <br /> <br />{" "}
				<strong>SECTION 19 - CHANGES TO TERMS OF SERVICE</strong> <br />{" "}
				You can review the most current version of the Terms of Service
				at any time at this page. <br /> We reserve the right, at our
