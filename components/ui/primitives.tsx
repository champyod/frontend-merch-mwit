...
export const Container = ({ children, className, maxWidth = "4xl", ...props }: BaseProps & { maxWidth?: "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "4xl" | "5xl" | "6xl" | "7xl" | "full" }) => {
  ...
  return (
    <div className={cn("container mx-auto px-4", maxMap[maxWidth], className)} {...props}>
      {children}
    </div>
  );
};
