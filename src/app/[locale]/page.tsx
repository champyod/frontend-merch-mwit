...
export default function Home() {
	...
	return (
		<Box as="main" className="min-h-screen">
			{/* Hero Section */}
			<Box as="section" className="relative min-h-screen flex items-center justify-center overflow-hidden py-20 px-4">
				<Box 
			...
			<Box as="section" id="products">
				<Container maxWidth="full" className="py-32">
					<Flex direction="col" className="md:items-end justify-between mb-16 md:flex-row" gap={4}>
						<Stack gap={2}>
